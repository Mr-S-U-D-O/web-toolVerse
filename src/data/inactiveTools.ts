export function getInactiveTools() {
  ...
  const ignoredIds = new Set([
    ...
    'code-python-formatter',
    'code-python-linter',
    'code-python-minifier',
    'code-python-obfuscator',
    'code-python-deobfuscator',
    'code-python-compiler',
    'code-python-interpreter',
    'code-python-syntax-checker',
    'code-python-documentation-generator',
    'code-python-snippet-generator',
    'code-python-type-converter',
    'code-python-boilerplate-generator',
    'code-python-regex-tester',
    'code-python-ast-viewer',
    'code-javascript-formatter',
    'code-javascript-linter',
    'code-javascript-minifier',
    'code-javascript-obfuscator',
    'code-javascript-deobfuscator',
    'code-javascript-compiler',
    'code-javascript-interpreter',
    'code-javascript-syntax-checker',
    'code-javascript-documentation-generator',
    'code-javascript-snippet-generator',
    'code-javascript-type-converter',
    'code-javascript-boilerplate-generator',
    'code-javascript-regex-tester',
    'code-javascript-ast-viewer',
    'code-typescript-formatter',
    'code-typescript-linter',
    'code-typescript-minifier',
    'code-typescript-obfuscator',
    'code-typescript-deobfuscator',
    'code-typescript-compiler',
    'code-typescript-interpreter',
    'code-typescript-syntax-checker',
    'code-typescript-documentation-generator',
    'code-typescript-snippet-generator',
    'code-typescript-type-converter',
    'code-typescript-boilerplate-generator',
    'code-typescript-regex-tester',
    'code-typescript-ast-viewer',
    'code-java-formatter',
    'code-java-linter',
    'code-java-minifier',
    'code-java-obfuscator',
    'code-java-deobfuscator',
    'code-java-compiler',
    'code-java-interpreter',
    'code-java-syntax-checker',
    'code-java-documentation-generator',
    'code-java-snippet-generator',
    'code-java-type-converter',
    'code-java-boilerplate-generator',
    'code-java-regex-tester',
    'code-java-ast-viewer',
    'code-c++-formatter',
    'code-c++-linter',
    'code-c++-minifier',
    'code-c++-obfuscator',
    ...
    'code-c++-compiler',
    'code-c++-interpreter',
    'code-c++-syntax-checker',
    'code-c++-documentation-generator',
    'code-c++-snippet-generator',
    'code-c++-type-converter',
    'code-c++-boilerplate-generator',
    'code-c++-regex-tester',
    'code-c++-ast-viewer',
    'code-c#-formatter',
    'code-c#-linter',
    ...
    'code-ruby-linter',
    'code-ruby-minifier',
    'code-ruby-obfuscator',
    'code-ruby-deobfuscator',
    'code-ruby-compiler',
    'code-ruby-interpreter',
    'code-ruby-syntax-checker',
    'code-ruby-documentation-generator',
    'code-ruby-snippet-generator',
    'code-ruby-type-converter',
    'code-ruby-boilerplate-generator',
    'code-ruby-regex-tester',
    'code-ruby-ast-viewer',
    'code-php-formatter',
    'code-php-linter'
  ]);
