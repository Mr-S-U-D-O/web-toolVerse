...
export function getSeoData(toolId: string, toolName: string, toolDescription: string): SeoData {
  ...
  // 5. Generate default FAQs if override is missing (guarantees 300+ words of keyword-rich content)
  const faq = override.faq || [
    {
    ...
    {
      question: `Can I use this ${toolName} offline?`,
      answer: `Yes. Once the page is loaded, the ${toolName} is fully functional without an internet connection. Because it does not rely on backend servers or APIs to do the processing, you can bookmark this page and perform tasks completely offline.`
    },
    {
