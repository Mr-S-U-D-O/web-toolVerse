...
export default function FinDiscountCalculatorTool({ onBack }: { onBack: () => void }) {
        ...
        <div className="max-w-4xl w-full mx-auto p-6 md:p-8">
          <div className="flex flex-col items-center justify-center mb-12 text-center">
            ...
            <p className="text-on-surface-variant max-w-2xl">
              Calculate final price after deducing the percentage discount.
            </p>
          </div>
          ...
          <div className="bg-surface-container rounded-3xl p-6 md:p-8 ring-1 ring-outline-variant">
            ...
            <div className="grid grid-cols-1 sm:grid-cols-2 gap-4">
              <div className="bg-surface-container-high p-4 rounded-xl border border-outline text-emerald-500">
