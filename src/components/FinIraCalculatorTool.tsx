...
export default function FinIraCalculatorTool({ onBack }: { onBack: () => void }) {
  const [contribution, setContribution] = useState<string>('6500');
        ...
        <div className="max-w-4xl w-full mx-auto p-6 md:p-8">
          <div className="flex flex-col items-center justify-center mb-12 text-center">
            ...
            <p className="text-on-surface-variant max-w-2xl">
              Calculate growth of Individual Retirement Account.
            </p>
          </div>
